---
title: Tutorials
description: Step-by-step guides for building real-world data pipelines
---
...
[Start Tutorial →](local-development.md)
</div>
...
Have an idea for a tutorial? [Open an issue](https://github.com/Infoblox-CTO/platform.data.kit/issues/new) with the `documentation` label.
